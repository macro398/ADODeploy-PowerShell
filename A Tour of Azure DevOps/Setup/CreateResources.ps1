...
$file = get-childitem 'L:\A Tour of Azure DevOps\Setup\*.json'|Get-Content
...
foreach($file in (get-childitem 'L:\A Tour of Azure DevOps\Setup\PBIs\*.json'))
{
   ...
   $folder = "L:\A Tour of Azure DevOps\Setup\PBIs\" + $apioutput.fields.'System.Title' + "\*.json"
